/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9473067aabdd3db557ce031ea53bf49)
// Runtime types generated with workerd@1.20260921.1 2026-09-25
interface __BaseEnv_Env {
	R2_BUCKET_NAME: "ai-meeting-minutes-recordings";
	VOICE_CHANNEL_SESSION: DurableObjectNamespace<import("./src/index").VoiceChannelSession>;
	GATEWAY_CONTROL: DurableObjectNamespace<import("./src/index").GatewayControl>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VoiceChannelSession" | "GatewayControl";
	}
